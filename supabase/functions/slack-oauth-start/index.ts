...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Build the callback URL — our slack-oauth-callback Edge Function
    ...
    // Build Slack OAuth consent URL
    // Using user_scope for user tokens (act as the user)
    const params = new URLSearchParams({
      client_id: clientId,
      redirect_uri: callbackUrl,
      state,
      user_scope: "channels:read,chat:write,users:read,team:read",
    });
